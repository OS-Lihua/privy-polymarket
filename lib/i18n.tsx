...
const dictionaries = {
  en: {
    ...
    eoaHelp:
      "This wallet signs actions for your Safe. Do not fund this address.",
    safeHelp:
      "Legacy Safe wallet. Use the migration button if it still holds pUSD.",
    depositWalletHelp:
    ...
    wrapping: "Wrapping",
    legacySafeBalance: "Legacy Safe balance",
    migrateSafePusd: "Migrate Safe pUSD",
    migrating: "Migrating",
    noLegacySafeBalance: "No legacy Safe pUSD balance to migrate.",
    migrationFailed: "Failed to migrate pUSD.",
    ...
    checkingSafe: "Checking Safe deployment",
    deployingSafe: "Deploying Safe wallet",
  ...
  zh: {
    ...
    safeHelp: "这是旧 Safe 钱包。如果里面还有 pUSD，请使用迁移按钮。",
    ...
    wrapping: "包装中",
    legacySafeBalance: "旧 Safe 余额",
    migrateSafePusd: "迁移 Safe pUSD",
    migrating: "迁移中",
    noLegacySafeBalance: "旧 Safe 没有可迁移的 pUSD。",
    migrationFailed: "迁移 pUSD 失败。",
    ...
    sessionActive: "会话已启用",
    endSession: "结束会话",
    checkingSafe: "检查 Safe 部署状态",
    deployingSafe: "部署 Safe 钱包",
