...
export const COLLATERAL_ONRAMP_ADDRESS =
  (process.env.NEXT_PUBLIC_COLLATERAL_ONRAMP_ADDRESS ||
    "0x93070a847efef7f70739046a929d47a521f5b8ee") as `0x${string}`;

export const CTF_CONTRACT_ADDRESS =
  (process.env.NEXT_PUBLIC_CTF_CONTRACT_ADDRESS ||
