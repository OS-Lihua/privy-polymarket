				...
				>
					...
					{!quote ? (
						<button
							...
							disabled={
								isCreatingQuote || totalPaymentNum < 2 || !depositWalletAddress
							}
	...
	return (
		<div className="mb-4 bg-white/5 rounded-lg p-3 space-y-2 text-sm">
			<SummaryRow
				...
				value={formatUsd(quote.totalAmountUsdcMicros)}
			/>
			<SummaryRow
				label={t("platformFee")}
				value={formatUsd(quote.feeAmountUsdcMicros)}
			/>
			<SummaryRow
				label={t("orderAmount")}
				value={formatUsd(quote.orderAmountUsdcMicros)}
			/>
